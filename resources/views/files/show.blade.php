...
<div class="modal-body p-5 w-75 m-auto mt-5 rounded bg-light text-center">

  <h2 class="text-primary"> You're Done !</h2>
  <p class="text-secondary">Copy your download link</p>
  <div class="border w-75 m-auto rounded mt-3 p-2 mb-2">
  ...
  <a href="{{route('files.downloadPage' , $file->id)}}" class="text-primary">downloadPage/{{$file->id}}</a>
    ...
    <a class="mb-2 w-25 btn btn-lg rounded btn-primary" href="{{route('files.index')}}" type="submit">send More ?</a>
    <hr class="my-4">
